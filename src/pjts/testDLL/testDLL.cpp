// testDLL.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
typedef FT_STATUS(*pfunc_I2C_InitChannel)(FT_HANDLE handle, I2C_ChannelConfig* config);
...
int main()
{
	...
	hdll_mpsse = LoadLibraryW(L"libMPSSE.dll");
	if (!hdll_mpsse)
	{
